...
},{"./data/gallery-items.js":"src/js/data/gallery-items.js"}],"src/js/set-attributes.js":[function(require,module,exports) {
"use strict";
...
},{"./refs.js":"src/js/refs.js"}],"src/js/modal-window.js":[function(require,module,exports) {
"use strict";
...
},{"./data/gallery-items.js":"src/js/data/gallery-items.js","./refs.js":"src/js/refs.js","./set-attributes.js":"src/js/set-attributes.js"}],"src/js/lazy-loading.js":[function(require,module,exports) {
"use strict";
...
var _lazyLoading = require("./lazy-loading");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// 1. Создание и рендер разметки по массиву данных galleryItems из app.js и предоставленному шаблону.
_refs.default.galleryContainerEl.insertAdjacentHTML('beforeend', _galleryMarkup.galleryElementsMarkup); // 2.Реализация делегирования на галерее ul.js-gallery и получение url большого изображения.


_refs.default.galleryContainerEl.addEventListener('click', onGalleryContainerClick);
...
_refs.default.lightboxOverlayEl.addEventListener('click', _modalWindow.onBackdropClick); // 7. Ленивая загрузка изображений
...
},{"./data/gallery-items":"src/js/data/gallery-items.js","./refs":"src/js/refs.js","./gallery-markup":"src/js/gallery-markup.js","./set-attributes":"src/js/set-attributes.js","./modal-window":"src/js/modal-window.js","./lazy-loading":"src/js/lazy-loading.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
